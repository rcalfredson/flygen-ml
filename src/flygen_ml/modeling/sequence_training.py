...
def _model_training_summary(model: dict[str, object]) -> dict[str, object]:
    return {
        ...
        "genotype_pooling": model.get("genotype_pooling"),
        "cohort_pooling": model.get("cohort_pooling"),
        "genotype_pooled_embedding_dim": model.get("genotype_pooled_embedding_dim"),
        ...
        "gru_hidden_dim": model.get("gru_hidden_dim"),
        "gru_layers": model.get("gru_layers"),
        "gru_bidirectional": model.get("gru_bidirectional"),
